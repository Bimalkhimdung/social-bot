...
export default function PostCard({ post, actions }) {
  ...
  return (
    <div className="card fade-in" style={{ display: 'flex', gap: 16, padding: 16 }}>
      {/* Thumbnail */}
      <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flexShrink: 0 }}>
        ...
        <button
          ...
          onClick={() => window.open(`http://localhost:8000/api/queue/${post.id}/preview-card`, '_blank')}
